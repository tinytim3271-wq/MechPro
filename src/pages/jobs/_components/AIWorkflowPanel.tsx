 ...
 * Used when interpolating user-controlled data into HTML strings.
 */
    ...
    printWindow.document.write(`
      ...
      ${items.map((item, i) => `
        <div class="item ${item.completed ? 'completed' : ''}">
          ...
          ${item.toolsRequired?.length ? `<div class="meta"><strong>Tools:</strong> ${item.toolsRequired.map(t => escapeHtml(t)).join(", ")}</div>` : ""}
    ...
    printWindow.document.write(`
      ...
      ${steps.map((step) => `
        <div class="step ${step.completed ? 'completed' : ''}">
          ...
          ${step.toolsRequired?.length ? `<div class="meta"><strong>Tools:</strong> ${step.toolsRequired.map(t => escapeHtml(t)).join(", ")}</div>` : ""}
