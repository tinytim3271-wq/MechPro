...
CREATE TABLE IF NOT EXISTS "orgMembers" (
  ...
  "jobTitle"        TEXT,
  "department"      TEXT,
  "filingStatus"    TEXT CHECK ("filingStatus" IN ('single','married','headOfHousehold')),
  "overtimeMultiplier" DOUBLE PRECISION,
  "stateTaxRate"    DOUBLE PRECISION,
  "payFrequency"    TEXT CHECK ("payFrequency" IN ('weekly','biweekly','semimonthly','monthly'))
);
